...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<div class='btn-group btn-group-sm float-right' role='group'>
			<a href="<?= base_url('pajakabt/tambah') ?>" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Tambah</a>
			<!-- <button class="btn btn-success" data-toggle="modal" data-target="#cetakDialog"><i class="fas fa-print"></i> Cetak</button> -->
		</div>
	</div>
	<div class="card-body">
		<div class="table-responsive-md">
			<table class="table table-hover table-striped table-sm" id="tabelPajakAir">

...
<div class="form-row mb-2">
    ...
    <!-- <input type="text" class="col-md-10 form-control form-control-sm maskField" blockpasting id="koordinat_ls" name="koordinat_ls" mask="99&deg;99&#8216;99.99&#8220;" value="<?= $koordinat_ls ?>">
    </div> -->

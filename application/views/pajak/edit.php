    ...
    <div class="col-xs-12">
     ...
     <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">Ubah Data Pajak</h3>
      </div>
      
      <!-- form start -->
      <form action="<?php echo base_url('pajak/update'); ?>" class="form-horizontal" method="post">
        <div class="box-body">

          <input type="hidden" name="id_pjk" value="<?php echo $data->id_pjk?>">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-2">
                <input type="text" name="nilai_pajak" class="form-control" value="<?php echo $data->nilai_pjk?>">
              </div>
            </div> 

            <div class="form-group">
              <label class="col-xs-2">Tanggal Pengambilan</label>
              <div class="col-xs-3">
                <input type="text" name="tgl_pjk" class="form-control datepicker" value="<?php echo $data->tgl_pjk?>">
              </div>
            </div> 

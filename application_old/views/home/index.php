      ...
      <div class="col-xs-7">
          ...
          <div class="col-lg-6 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              ...
              <a href="<?=base_url('sumur?filter1=3&zona=&wilayah=&perusahaan=&izin=1&status=1&jns_sumur=')?>" class="small-box-footer">
                Lihat <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-xs-6">
            ...
            <div class="small-box bg-red">
              ...
              <a href="<?=base_url('sumur?filter1=3&zona=&wilayah=&perusahaan=&izin=1&status=2&jns_sumur=')?>" class="small-box-footer">
                Lihat <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>

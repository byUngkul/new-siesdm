...
<script>
  $(document).ready(function () {
    $('#form-tanggal, #form-bulan, #form-tahun, #form-zona, #form-perusahaan1, #form-izin, #form-wilayah, #form-izin, #form-jenis, #form-satus').hide(); // Sebagai default kita sembunyikan form filter tanggal, bulan & tahunnya
  ...
  $("#perusahaan").change(function(){
   ...
   $('#filter1').change(function(){
          if($(this).val() == '1'){
                ...
                $('#form-wilayah, #form-status, #form-izin').show();
          ...
          $('#form-tanggal input, #form-bulan select, #form-tahun select, #form-zona select, #form-perusahaan1 select, #form-izin select, #form-wilayah select, #form-izin select, #form-jenis select, #form-status select').val('');          
      });
